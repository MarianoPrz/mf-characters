...
import i18nFutInstance from "./i18n";
...
const App = () => {
    ...
    const [selectedLanguage, setSelectedLanguage] = useState<string>(i18nFutInstance.language);
    const toggleTheme = (): void => {
        themeMode === "light" ? setThemeMode("dark") : setThemeMode("light");
    }
    const onLanguageChange = (language: string) => {
        setSelectedLanguage(language);
        i18nFutInstance.changeLanguage(language);
    };
